define(['hogan'], function(Hogan) {
  var t = {
    ...
    'cards' : new Hogan.Template({code: function (c,p,i) { var t=this;t.b(i=i||"");if(t.s(t.f("cards",c,p,1),c,p,0,10,24,"{{ }}")){t.rs(c,p,function(c,p,t){t.b(t.rp("<card0",c,p,"  "));});c.pop();}return t.fl(); },partials: {"<card0":{name:"card", partials: {}, subs: {  }}}, subs: {  }})
    /* jshint ignore:end */
  },
  r = function(n) {
    var tn = t[n];
